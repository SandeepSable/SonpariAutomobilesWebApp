...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <title style="font-family:Shivaji01;">Welcome: Sonpari Automobiles Kannad. Web Application</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Free HTML5 Template by FREEHTML5.CO" />
	<meta name="keywords" content="Demo Application" />
	<meta name="author" content="demo app" />
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="./voltage/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="./voltage/css/icomoon.css">
	<!-- Magnific Popup-->
	<link rel="stylesheet" href="./voltage/css/magnific-popup.css">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="./voltage/css/owl.carousel.min.css">
	<link rel="stylesheet" href="./voltage/css/owl.theme.default.min.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="./voltage/css/bootstrap.css">
	
	<!-- Cards -->
	<link rel="stylesheet" href="./voltage/css/cards.css">

	<!-- Modernizr JS -->
	<script src="./voltage/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	<script src="./voltage/js/respond.min.js"></script>
	<![endif]-->
	...
	<div id="fh5co-page">
		<nav class="fh5co-nav-style-1" role="navigation" data-offcanvass-position="fh5co-offcanvass-left">
			<div class="">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 fh5co-logo">
					...
					<a href="#">Automobile Shop</a>
				</div>
				<div class="col-lg-6 col-md-5 col-sm-5 text-center fh5co-link-wrap">
					<ul data-offcanvass="yes">
						<li class="active"><a href="#pricing">Machines</a></li>
						<li><a href="#projects">Shoping</a></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-4 text-right fh5co-link-wrap">
					<ul class="fh5co-special" data-offcanvass="yes">
						...
						<li><a href="./new-user" class="call-to-action">Register</a></li>
					</ul>
				</div>
			</div>
		</nav>
		...
		<div class="fh5co-cover fh5co-cover-style-2 js-full-height" data-stellar-background-ratio="0.5" data-next="yes"  style="background-image: url(./voltage/images/full_1.jpg);">
			...
			<div class="fh5co-cover-text">
				<div class="container">
					<div class="row">
						<div class="col-md-push-3 col-md-6 full-height js-full-height">
							<div class="fh5co-cover-intro">
								<h1 class="cover-text-lead wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">Sonpari Automobiles</h1>
								<h2 class="cover-text-sublead wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s">Automobile shoppy for all kinds of mechanical and tools which are required for day to day life.</h2>
								<p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.1s"><a href="./home" class="btn btn-primary btn-outline btn-lg">Open Application Here</a></p>
							</div>
						</div>
					</div>
				</div>	
		...
		<div id="projects" class="fh5co-project-style-2">
			<div class="container">
				<div class="row p-b">
			...
			<div class="fh5co-projects">
				<ul>
					<li class="wow fadeInUp" style="background-image: url(./voltage/images/full_4.jpg);" data-wow-duration="1s" data-wow-delay="1.4s" data-stellar-background-ratio="0.5">
						<a href="#">
							<div class="fh5co-overlay"></div>
							<div class="container">
					...
					<li class="wow fadeInUp" style="background-image: url(./voltage/images/full_2.jpg);" data-wow-duration="1s" data-wow-delay="1.7s" data-stellar-background-ratio="0.5">
						<a href="#">
							<div class="fh5co-overlay"></div>
							<div class="container">
								<div class="fh5co-text">
					...
					<li class="wow fadeInUp" style="background-image: url(./voltage/images/full_1.jpg);" data-wow-duration="1s" data-wow-delay="2s" data-stellar-background-ratio="0.5">
						<a href="#">
							<div class="fh5co-overlay"></div>
							<div class="container">
								<div class="fh5co-text">
					...
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
						<div class="fh5co-post wow fadeInLeft"  data-wow-duration="1s" data-wow-delay="1.1s">
							<div class="fh5co-post-image">
								...
								<img src="./voltage/images/img_same_dimension_2.jpg" alt="Image" class="img-responsive">
							</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
						<div class="fh5co-post wow fadeInLeft"  data-wow-duration="1s" data-wow-delay="1.4s">
							<div class="fh5co-post-image">
								...
								<img src="./voltage/images/img_same_dimension_3.jpg" alt="Image" class="img-responsive">
							</div>
							<div class="fh5co-post-text">
					...
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
						<div class="fh5co-post wow fadeInLeft"  data-wow-duration="1s" data-wow-delay="1.7s">
							<div class="fh5co-post-image">
								...
								<img src="./voltage/images/img_same_dimension_4.jpg" alt="Image" class="img-responsive">
							</div>
							<div class="fh5co-post-text">
		...
		<div class="fh5co-features-style-1" style="background-image: url(./voltage/images/full_4.jpg);" data-stellar-background-ratio="0.5">
			<div class="fh5co-overlay"></div>
		...
		<div id="pricing" class="fh5co-pricing-style-2">
			<div class="container">
				<div class="row">
					<div class="row p-b">
						<div class="col-md-6 col-md-offset-3 text-center">
				...
				<div class="row">
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
						<a href="#" class="link-block">
							<figure><img src="./voltage/images/img_same_dimension_1.jpg" alt="Image" class="img-responsive img-rounded"></figure>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".8s">
						<a href="#" class="link-block">
							<figure><img src="./voltage/images/img_same_dimension_2.jpg" alt="Image" class="img-responsive img-rounded"></figure>
							<h3>Retina Ready</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<p><a href="#" class="btn btn-primary btn-sm">Learn More</a></p>
						</a>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.1s">
						<a href="#" class="link-block">
							<figure><img src="./voltage/images/img_same_dimension_3.jpg" alt="Image" class="img-responsive img-rounded"></figure>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.4s">
						<a href="#" class="link-block">
							<figure><img src="./voltage/images/img_same_dimension_4.jpg" alt="Image" class="img-responsive img-rounded"></figure>
							<h3>Responsive Layout</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							<p><a href="#" class="btn btn-primary btn-sm">Learn More</a></p>
						</a>
		...
		<div class="fh5co-counter-style-2" style="background-image: url(./voltage/images/full_2.jpg);" data-stellar-background-ratio="0.5">
			<div class="fh5co-overlay"></div>
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-testimonial-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.1s">
							<div class="fh5co-name">
								<img src="./voltage/images/person_5.jpg" alt="">
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-testimonial-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.4s">
							<div class="fh5co-name">
								<img src="./voltage/images/person_4.jpg" alt="">
								<div class="fh5co-meta">
									<h3>Ian Stewart</h3>
									<span class="fh5co-company">XYZ Inc.</span>
								</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-testimonial-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.7s">
							<div class="fh5co-name">
								<img src="./voltage/images/person_3.jpg" alt="">
								<div class="fh5co-meta">
									<h3>Mitch Silk</h3>
									<span class="fh5co-company">XYZ Inc.</span>
								</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-testimonial-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
							<div class="fh5co-name">
								<img src="./voltage/images/person_1.jpg" alt="">
								<div class="fh5co-meta">
									<h3>Beth Glasgow</h3>
									<span class="fh5co-company">XYZ Inc.</span>
								</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-testimonial-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="2.3s">
							<div class="fh5co-name">
								<img src="./voltage/images/person_2.jpg" alt="">
								<div class="fh5co-meta">
									<h3>Rob Smith</h3>
									<span class="fh5co-company">XYZ Inc.</span>
								</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="fh5co-testimonial-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="2.6s">
							<div class="fh5co-name">
								<img src="./voltage/images/person_6.jpg" alt="">
								<div class="fh5co-meta">
									<h3>Colleen Bass</h3>
									<span class="fh5co-company">XYZ Inc.</span>
								</div>
			...
			<div class="container">
				<div class="row p-b">
					<div class="col-md-3 col-sm-6 fh5co-footer-widget wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
						...
						<p class="fh5co-copyright">&copy; 2016 Voltage. <br>All Rights Reserved. <br>Designed by <a target="_blank" href="http://satsun.com">FREEHTML5.co</a> <br>Created with <a target="_blank" href="http://www.google.com/cards">Cards</a> <br> 
	...
	<!-- jQuery -->
	<script src="./voltage/js/jquery.min.js"></script>
	<!-- jQuery Easing -->
	<script src="./voltage/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="./voltage/js/bootstrap.min.js"></script>
	<!-- Waypoints -->
   <script src="./voltage/js/jquery.waypoints.min.js"></script>
	<!-- Owl Carousel -->
	<script src="./voltage/js/owl.carousel.min.js"></script>
	<!-- Magnific Popup -->
	<script src="./voltage/js/jquery.magnific-popup.min.js"></script>
	<!-- Stellar -->
	<script src="./voltage/js/jquery.stellar.min.js"></script>
	<!-- countTo -->
	<script src="./voltage/js/jquery.countTo.js"></script>
	<!-- WOW -->
	<script src="./voltage/js/wow.min.js"></script>
	<script>
		new WOW().init();
	</script>
	<!-- Main -->
	<script src="./voltage/js/main.js"></script>
