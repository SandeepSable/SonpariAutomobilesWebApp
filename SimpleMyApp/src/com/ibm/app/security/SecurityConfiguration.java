...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/").permitAll()
				...
				.antMatchers("/add-stock").access("hasAnyRole('ADMIN','DBA')")
				...
				.antMatchers("/add-product").access("hasAnyRole('ADMIN', 'DBA')")
				.antMatchers("/edit-product-*").access("hasAnyRole('ADMIN', 'DBA')")
				.antMatchers("/delete-product-*").access("hasAnyRole('ADMIN', 'DBA')")
